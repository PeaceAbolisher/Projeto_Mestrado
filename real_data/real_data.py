# # All here ---> https://colab.research.google.com/drive/12l--DqvD0cTGx8dRm0XCSLbsCtUOgfSE?usp=sharing
#dataset pivot is also there
...
#Obesity Project 
healthy_data_path = r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\data\Obesity\healthy_samples"
...
healthy_data['relative_abundance'] = pd.to_numeric(healthy_data['relative_abundance'], errors='coerce')

#Agregar dados por abundância
aggregated_data = healthy_data.groupby("scientific_name")["relative_abundance"].sum().reset_index()
...
plt.title("before: Top 20 Most Abundant Species Across All Healthy Samples")
plt.axis('equal')  # Ensures the pie chart is drawn as a circle
plt.show()


#contar nr entradas
species_count = healthy_data['scientific_name'].value_counts().reset_index()
...
plt.ylabel('Species')
plt.title('before: Top 50 Most Common Species by Number of Entries for Healthy Samples')
...
plt.xlabel('Number of Entries')
plt.ylabel('Species')
plt.title('AFTER: Top 50 Most Common Species by Number of Entries for Healthy Samples')
...
#------------------------------------------------------- DIABETIC ------------------------------------------------------------
#Obesity Project 
diabetic_data_path = r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\data\Obesity\obese_samples"
