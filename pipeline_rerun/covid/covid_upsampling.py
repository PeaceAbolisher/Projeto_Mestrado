...
print("\n[INFO] Starting Random Upsampling-Balanced Model Selection Pipeline For COVID...\n")
# --- Model Setup ---
models = {
...
print("Model saved to     : 'covid_best_model_upsampling.pkl'")
print("=" * 40)
...
cm_df = pd.DataFrame(
    cm,
    index=["Actual Healthy", "Actual COVID"],
...
joblib.dump(best_model_pipeline, 'covid_best_model_upsampling.pkl')