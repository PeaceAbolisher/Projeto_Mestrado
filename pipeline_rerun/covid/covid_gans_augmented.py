...
print("\n[INFO] Starting GANS-Balanced And Augmentation Model Selection Pipeline For COVID...\n")
# --- Model Setup ---
models = {
...
#Load dataset
data = pd.read_csv(r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\data\COVID\all_data_samples\merged_covid_dataset.csv", dtype=str)
...
print("Model saved to     : 'covid_best_model_gans_augmented.pkl'")
print("=" * 40)

# Confusion matrix
cm = confusion_matrix(y_test, test_pred)
cm_df = pd.DataFrame(cm,index=["Actual Healthy", "Actual COVID"],columns=["Predicted Healthy", "Predicted COVID"])
...
joblib.dump(best_model_pipeline, 'covid_best_model_gans_augmented.pkl')