...
print("\n[INFO] Starting SMOTE-Balanced Model Selection Pipeline For COVID...\n")
# --- Model Setup ---
models = {
...
print("Model saved to     : 'covid_best_model_smote.pkl'")
print("=" * 40)
...
joblib.dump(best_model_pipeline, 'covid_best_model_smote.pkl')