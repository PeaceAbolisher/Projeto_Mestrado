...
# ----------------- CONFIG -----------------
DATA_CSV = r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\data\COVID\all_data_samples\merged_covid_dataset.csv"

# >>> Here you can put full paths for each model <<<
MODEL_FILES = [
    r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\output\covid_dataset\gans_augmented\covid_best_model_gans_augmented.pkl",
    r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\output\covid_dataset\gans\covid_best_model_gans.pkl",
    r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\output\covid_dataset\smote\covid_best_model_smote.pkl",
    r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\output\covid_dataset\upsampling\covid_best_model_upsampling.pkl",
]

OUTDIR = Path("covid_shap_reports"); OUTDIR.mkdir(exist_ok=True)
RANDOM_STATE = 42
