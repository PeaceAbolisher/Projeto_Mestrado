...
print("Model saved to     : 'arthritis_best_model_gans_augmented.pkl'")
print("=" * 40)

# Confusion matrix
cm = confusion_matrix(y_test, test_pred)
cm_df = pd.DataFrame(cm,index=["Actual Healthy", "Actual Arthritis"],columns=["Predicted Healthy", "Predicted Arthritis"])
...
joblib.dump(best_model_pipeline, 'arthritis_best_model_gans_augmented.pkl')