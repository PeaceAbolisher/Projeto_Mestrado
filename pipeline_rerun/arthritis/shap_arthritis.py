...
# ----------------- CONFIG -----------------
DATA_CSV = r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\data\Rheumatoid_Arthritis\all_data_samples\merged_arthritis_dataset.csv"

# >>> Here you can put full paths for each model <<<
MODEL_FILES = [
    r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\output\arthritis_dataset\gans_augmented\arthritis_best_model_gans_augmented.pkl",
    r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\output\arthritis_dataset\gans\arthritis_best_model_gans.pkl",
    r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\output\arthritis_dataset\smote\arthritis_best_model_smote.pkl",
    r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\output\arthritis_dataset\upsampling\arthritis_best_model_upsampling.pkl",
]

OUTDIR = Path("arthritis_shap_reports"); OUTDIR.mkdir(exist_ok=True)
RANDOM_STATE = 42
