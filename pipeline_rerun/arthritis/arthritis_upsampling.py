...
print("\n[INFO] Starting Random Upsampling-Balanced Model Selection Pipeline For Rheumatoid Arthritis...\n")
# --- Model Setup ---
models = {
...
#Load dataset
data = pd.read_csv(r"C:\Users\Rafael Fonseca\Desktop\Mestrado\Ano2\ProjetoMestrado\parte_2\data\Rheumatoid_Arthritis\all_data_samples\merged_arthritis_dataset.csv", dtype=str)
...
print("Model saved to     : 'arthritis_best_model_upsampling.pkl'")
print("=" * 40)
...
cm_df = pd.DataFrame(
    cm,
    index=["Actual Healthy", "Actual Arthritis"],
    columns=["Predicted Healthy", "Predicted Arthritis"]
)
...
joblib.dump(best_model_pipeline, 'arthritis_best_model_upsampling.pkl')