...
print("\n[INFO] Starting SMOTE-Balanced Model Selection Pipeline For Obesity...\n")
# --- Model Setup ---
models = {
...
print("Model saved to     : 'obesity_best_model_smote.pkl'")
print("=" * 40)
...
joblib.dump(best_model_pipeline, 'obesity_best_model_smote.pkl')