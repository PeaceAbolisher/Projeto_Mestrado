    ...
    for method in selection_methods:
        for base_name, base_model in rfe_base_models.items():
            ...
            if all_results:
                ...
                result_key = f"smote-v2-{scaler_name}-{method}-{base_name}-{best_label}"
...
print("Model saved to     : 'best_model_smote_v2_sem_metadata.pkl'")
print("=" * 40)
...
joblib.dump(best_model_pipeline, 'best_model_smote_v2_sem_metadata.pkl')