...
print("\n[INFO] Starting Random Upsampling-Balanced Model Selection Pipeline Sem Metadata...\n")
# --- Model Setup ---
models = {
...
# Drop ID + metadata
METADATA_COLS = ['sample_id', 'Country', 'Age']
data.drop(columns=[c for c in METADATA_COLS if c in data.columns], inplace=True, errors='ignore')
...
print("Model saved to     : 'best_model_upsampling_sem_metadata.pkl'")
print("=" * 40)
...
joblib.dump(best_model_pipeline, 'best_model_upsampling_sem_metadata.pkl')