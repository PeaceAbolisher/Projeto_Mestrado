...
print("\n[INFO] Starting SMOTE-Balanced Model Selection Pipeline SEM METADATA...\n")
# --- Model Setup ---
models = {
...
print("Model saved to     : 'best_model_smote_sem_metadata.pkl'")
print("=" * 40)
...
joblib.dump(best_model_pipeline, 'best_model_smote_sem_metadata.pkl')