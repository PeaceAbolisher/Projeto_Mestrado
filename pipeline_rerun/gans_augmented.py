# GANS Class Balancing and DATA AUGMENTATION
import numpy as np
import pandas as pd
import joblib
import copy
...
print("\n[INFO] Starting GANS-Augmented Model Selection Pipeline...\n")
# --- Model Setup ---
models = {
...
if extra_samples_needed > 0:
    print(f"Augmenting dataset with {extra_samples_needed} additional synthetic samples (any class)")
...
print("Model saved to     : 'best_model_gans_augmented.pkl'")
print("=" * 40)
...
joblib.dump(best_model_pipeline, 'best_model_gans_augmented.pkl')